...
public class LoggingAspect {
	...
	// * 주의할 점
	// 1) @Around 사용 시 반환형 Object 이어야 함
	// 2) @Around 메서드 종료 시 proceed() 반환 값을 꼭 return 해야 함
	...
	public Object aroundServiceImpl(ProceedingJoinPoint pjp) throws Throwable {
		...
		// Throwable 자식 : Exception(예외) / Error(오류) 
	...
	// "@annotation(org.springframework.transaction.annotation.Transactional)" : @Transactional 어노테이션이 작성되어 있는 부분을 대상으로 함
	// throwing = "ex" : 발생한 예외 객체 이름
