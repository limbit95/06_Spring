...
-- 단, 최신글이 제일 위에 존재
-- 초/분/시간 전 또는 YYYY-MM-DD 형식으로 작성일 조회
-- + 댓글 개수
-- + 좋아요 개수
...
-- 현재 시간 - 한시간 전
SELECT (SYSDATE - TO_DATE('2024-04-21 12:00:30', 'YYYY-MM-DD HH24:MI:SS')) * 60 * 60 * 24 FROM DUAL;
...
INSERT INTO "BOARD_IMG" VALUES(
	SEQ_IMG_NO.NEXTVAL, '/images/board/', '원본1.jpg', 'test1.jpg', 0, 1978
);

INSERT INTO "BOARD_IMG" VALUES(
	SEQ_IMG_NO.NEXTVAL, '/images/board/', '원본2.jpg', 'test2.jpg', 1, 1978
);

INSERT INTO "BOARD_IMG" VALUES(
	SEQ_IMG_NO.NEXTVAL, '/images/board/', '원본3.jpg', 'test3.jpg', 2, 1978
);

INSERT INTO "BOARD_IMG" VALUES(
	SEQ_IMG_NO.NEXTVAL, '/images/board/', '원본4.jpg', 'test4.jpg', 3, 1978
);

INSERT INTO "BOARD_IMG" VALUES(
	SEQ_IMG_NO.NEXTVAL, '/images/board/', '원본5.jpg', 'test5.jpg', 4, 1978
);
...
SELECT BOARD_NO, BOARD_TITLE, BOARD_CONTENT, BOARD_CODE, READ_COUNT,
	...
	(SELECT COUNT(*)
	 FROM "BOARD_LIKE"
	 WHERE BOARD_NO = 1978) LIKE_COUNT,
...
-- 댓글 0개인 BOARD_NO = 2001

-- 1레벨 부모 댓글 INSERT

INSERT INTO "COMMENT" 
VALUES(SEQ_COMMENT_NO.NEXTVAL,
	'부모 댓글 1', DEFAULT, DEFAULT, 1990, 2, NULL); -- COMMENT_NO = 2008

INSERT INTO "COMMENT" 
VALUES(SEQ_COMMENT_NO.NEXTVAL,
	'부모 댓글 2', DEFAULT, DEFAULT, 1990, 2, NULL); -- COMMENT_NO = 2009
	
INSERT INTO "COMMENT" 
VALUES(SEQ_COMMENT_NO.NEXTVAL,
	'부모 댓글 3', DEFAULT, DEFAULT, 1990, 2, NULL); -- COMMENT_NO = 2010

-- 2레벨 자식 댓글 INSERT
SELECT * FROM "COMMENT" WHERE BOARD_NO = 1990;
-- 부모 1의 자식 댓글

VALUES(SEQ_COMMENT_NO.NEXTVAL,
	'부모 1의 자식 1', DEFAULT, DEFAULT, 1990, 2, 2008); -- COMMENT_NO = 2006
...
INSERT INTO "COMMENT" 
VALUES(SEQ_COMMENT_NO.NEXTVAL,
	'부모 1의 자식 2', DEFAULT, DEFAULT, 1983, 2, 2001); -- COMMENT_NO = 2005
	
-- 부모 2의 자식 댓글
INSERT INTO "COMMENT" 
VALUES(SEQ_COMMENT_NO.NEXTVAL,
	'부모 2의 자식 1', DEFAULT, DEFAULT, 1983, 2, 2002); -- COMMENT_NO = 2007
...
INSERT INTO "COMMENT" 
VALUES(SEQ_COMMENT_NO.NEXTVAL,
	'부모 2의 자식 1의 자식', DEFAULT, DEFAULT, 1983, 2, 2007); -- COMMENT_NO = 2008
...
START WITH PARENT_COMMENT_NO IS NULL
-- 부모의 COMMENT_NO 와 같은 PARENT_COMMENT_NO 를 가진 행을 자식으로 지정
CONNECT BY PRIOR COMMENT_NO = PARENT_COMMENT_NO
-- 형제(같은 레벨 부모, 자식)들 간의 정렬 순서를 COMMENT_NO 오름 차순으로 지정
ORDER SIBLINGS BY COMMENT_NO;
...
-- 자식 댓글이 있는 부모 댓글 지워보고 화면에 어떻게 나오는지 확인
UPDATE "COMMENT" SET COMMENT_DEL_FL = 'Y'
WHERE COMMENT_NO = 2003;


SELECT * FROM "BOARD" WHERE BOARD_NO = 2002;
...
-- "BOARD_IMG" : NVARCHAR2(50)
-- "MEMBER" : VARCHAR2(300)
-- 데이터 타입이 맞지 않아 UNION이 수행 되지 않으므로
-- CAST(컬럼명 AS 변환할 데이터타입) 함수를 사용해 변환해주어야 한다
