...
CREATE USER spring_lsh IDENTIFIED BY spring1234;

GRANT CONNECT, RESOURCE TO spring_lsh;

ALTER USER spring_lsh DEFAULT TABLESPACE SYSTEM QUOTA UNLIMITED ON SYSTEM;
...
CREATE TABLE "EMPLOYEE" (
	...
	EMP_NICKNAME NVARCHAR2(50),
	EMP_TEL NVARCHAR2(50),
	EMP_BRITH DATE
);
...
CREATE TABLE "USER_GROUP" (
    ...
    parent_id NUMBER,
    CONSTRAINT FK_USER_GROUP FOREIGN KEY (parent_id) REFERENCES "USER_GROUP" (id)
);
INSERT INTO "USER_GROUP" (id, name, parent_id) VALUES (1, '인사팀', NULL);
INSERT INTO "USER_GROUP" (id, name, parent_id) VALUES (2, '영업팀', NULL);
INSERT INTO "USER_GROUP" (id, name, parent_id) VALUES (3, '재무팀', NULL);
