...
@RequestMapping("example") // /example로 시작하는 주소를 해당 Controller에 매핑
@Slf4j // lombok 라이브러리가 제공하는 로그 객체 자동생성 어노테이션
public class ExampleController {
	
	// Model
	// - Spring 데이터 전달 역할을 하는 객체
	...
	public String ex1(HttpServletRequest req,
		...
		return "example/ex1"; // src/main/resources/templates/example/ex1.html 요청 위임
	}
	...
	public String ex5(Model model) {
		...
		// 기본적으로 request scope + sessiong으로 확장 가능
